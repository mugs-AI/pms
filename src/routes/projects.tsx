  ...
  component: () => (
    <AppShell>
      <div className="space-y-4">
        <h1 className="font-display text-3xl font-bold tracking-wide text-foreground">Projects</h1>
        <div className="rounded-lg border border-dashed border-border bg-card/60 p-6">
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            The project register (enquiries, one primary N3 Project Code per project, optional
            phase-level codes, BOQ and budgets) is scheduled for a later milestone. N3 Project Codes
            can already be read on the verification screen.
          </p>
        </div>
      </div>
    </AppShell>
